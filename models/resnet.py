...
def resnet18(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torchvision.models.ResNet18_Weights.DEFAULT.get_state_dict(progress=progress), strict=False)
    return model
...
def resnet50(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torchvision.models.ResNet50_Weights.DEFAULT.get_state_dict(progress=progress), strict=False)
    return model
